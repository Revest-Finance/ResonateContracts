 ...
 */
contract jusdcAdapter is PermissionedAdapter, RariVault {
    ...
    constructor(ERC20 _asset, address _adapter, address _router, address _vault, address _feeHelper, address _whitelist, address _uvrt, address _dust_wallet) RariVault(_asset) {
        adapter = _adapter;
        router = _router;
        vault = _vault;
